...
## Reset 1 — SUCESSO (1850 ms)

| # | Arquivo | Tipo | Resultado | Tempo | Avisos |
| --- | --- | --- | --- | --- | --- |
| 1 | `00-auth-shim.sql` | shim | ok | 25 ms | — |
| 2 | `01_foundation.sql` | migration | ok | 42 ms | — |
| 3 | `02_identity_media.sql` | migration | ok | 38 ms | — |
| 4 | `03_catalog.sql` | migration | ok | 104 ms | — |
| 5 | `04_learning.sql` | migration | ok | 73 ms | — |
| 6 | `05_enrollment.sql` | migration | ok | 45 ms | — |
| 7 | `06_commerce.sql` | migration | ok | 59 ms | — |
| 8 | `07_funnel.sql` | migration | ok | 54 ms | — |
| 9 | `08_cms.sql` | migration | ok | 56 ms | — |
| 10 | `09_compliance_analytics.sql` | migration | ok | 48 ms | — |
| 11 | `10_business_logic.sql` | migration | ok | 4 ms | — |
| 12 | `11_rls.sql` | migration | ok | 27 ms | — |
| 13 | `12_bootstrap.sql` | migration | ok | 8 ms | — |
| 14 | `13_demo_cleanup.sql` | migration | ok | 1 ms | — |
| 15 | `14_corrige_liberacao.sql` | migration | ok | 1 ms | — |
| 16 | `15_papeis_comercial_financeiro.sql` | migration | ok | 5 ms | — |
| 17 | `16_corrige_guarda_de_papel.sql` | migration | ok | 1 ms | — |
| 18 | `17_quiz_perguntas.sql` | migration | ok | 13 ms | — |
| 19 | `18_corrige_remocao_demo.sql` | migration | ok | 4 ms | — |
| 20 | `19_segmentacao_ancora.sql` | migration | ok | 3 ms | — |
| 21 | `20_storage.sql` | migration | ok | 14 ms | — |
| 22 | `21_bootstrap_admin.sql` | migration | ok | 4 ms | — |
| 23 | `22_biblioteca_comunidade.sql` | migration | ok | 93 ms | — |
| 24 | `23_formacao_capitulos.sql` | migration | ok | 7 ms | — |
| 25 | `24_upload_video_aula.sql` | migration | ok | 12 ms | — |
| 26 | `25_upload_resumivel.sql` | migration | ok | 7 ms | — |
| 27 | `26_vagas_de_imagem_landing.sql` | migration | ok | 2 ms | — |
| 28 | `27_corrige_destino_da_oferta.sql` | migration | ok | 3 ms | — |
| 29 | `28_acesso_por_pacote.sql` | migration | ok | 6 ms | — |
| 30 | `29_pacotes_da_formacao.sql` | migration | ok | 9 ms | — |
| 31 | `seed.sql` | seed | ok | 10 ms | NOTICE: Seed de demonstracao aplicado. Rode select public.remove_demo_content() antes de publicar. |

## Reset 2 — SUCESSO (1572 ms)

| # | Arquivo | Tipo | Resultado | Tempo | Avisos |
| --- | --- | --- | --- | --- | --- |
| 1 | `00-auth-shim.sql` | shim | ok | 30 ms | — |
| 2 | `01_foundation.sql` | migration | ok | 34 ms | — |
| 3 | `02_identity_media.sql` | migration | ok | 31 ms | — |
| 4 | `03_catalog.sql` | migration | ok | 69 ms | — |
| 5 | `04_learning.sql` | migration | ok | 53 ms | — |
| 6 | `05_enrollment.sql` | migration | ok | 32 ms | — |
| 7 | `06_commerce.sql` | migration | ok | 43 ms | — |
| 8 | `07_funnel.sql` | migration | ok | 45 ms | — |
| 9 | `08_cms.sql` | migration | ok | 44 ms | — |
| 10 | `09_compliance_analytics.sql` | migration | ok | 34 ms | — |
| 11 | `10_business_logic.sql` | migration | ok | 4 ms | — |
| 12 | `11_rls.sql` | migration | ok | 25 ms | — |
| 13 | `12_bootstrap.sql` | migration | ok | 8 ms | — |
| 14 | `13_demo_cleanup.sql` | migration | ok | 2 ms | — |
| 15 | `14_corrige_liberacao.sql` | migration | ok | 1 ms | — |
| 16 | `15_papeis_comercial_financeiro.sql` | migration | ok | 4 ms | — |
| 17 | `16_corrige_guarda_de_papel.sql` | migration | ok | 2 ms | — |
| 18 | `17_quiz_perguntas.sql` | migration | ok | 15 ms | — |
| 19 | `18_corrige_remocao_demo.sql` | migration | ok | 1 ms | — |
| 20 | `19_segmentacao_ancora.sql` | migration | ok | 3 ms | — |
| 21 | `20_storage.sql` | migration | ok | 14 ms | — |
| 22 | `21_bootstrap_admin.sql` | migration | ok | 2 ms | — |
| 23 | `22_biblioteca_comunidade.sql` | migration | ok | 92 ms | — |
| 24 | `23_formacao_capitulos.sql` | migration | ok | 5 ms | — |
| 25 | `24_upload_video_aula.sql` | migration | ok | 12 ms | — |
| 26 | `25_upload_resumivel.sql` | migration | ok | 5 ms | — |
| 27 | `26_vagas_de_imagem_landing.sql` | migration | ok | 1 ms | — |
| 28 | `27_corrige_destino_da_oferta.sql` | migration | ok | 2 ms | — |
| 29 | `28_acesso_por_pacote.sql` | migration | ok | 6 ms | — |
| 30 | `29_pacotes_da_formacao.sql` | migration | ok | 8 ms | — |
| 31 | `seed.sql` | seed | ok | 11 ms | NOTICE: Seed de demonstracao aplicado. Rode select public.remove_demo_content() antes de publicar. |
